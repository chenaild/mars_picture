			...
			<view class="cont u-flex-col u-col-center" :style="{width: ad?'300px':'520rpx'}">
				...
				<view class="" v-else-if="ad">
					<view class="u-p-t-20" style="width: 300px;">
						<!-- #ifdef MP-QQ -->
						<ad :unit-id="adqqBannerUnitId"></ad>
						<!-- #endif -->
						<!-- #ifdef MP-WEIXIN -->
						<ad :unit-id="adwxBannerUnitId"></ad>
						<!-- #endif -->
					</view>
	...
	export default {
		...
		methods: {
			...
			getConfig(){
				...
				that.adwxBannerUnitId = config.adwxBannerUnitId
				that.adqqBannerUnitId = config.adqqBannerUnitId
			},
		},
		created() {
		    this.getConfig()
